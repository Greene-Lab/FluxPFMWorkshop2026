...
- How reliability of functional connectivity is calculated using all data
   - pearson r
   - ICC?? <-- can I get that to run locally??
- What the resulting reliability looks like with all data vs. only one session
   - the importance of interpreting these curves over a single to multiple sessions. 
